...
public class CustomFastScrollView extends FrameLayout implements OnScrollListener, OnHierarchyChangeListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs,
                    R.styleable.com_zia_freshdocs_widget_fileexplorer_CustomFastScrollView);
            mOverlayHeight = typedArray.getDimensionPixelSize(
                    R.styleable.com_zia_freshdocs_widget_fileexplorer_CustomFastScrollView_overlayHeight, 0);
            mOverlayWidth = typedArray.getDimensionPixelSize(
                    R.styleable.com_zia_freshdocs_widget_fileexplorer_CustomFastScrollView_overlayWidth, 0);
            mOverlayTextSize = typedArray.getDimensionPixelSize(
                    R.styleable.com_zia_freshdocs_widget_fileexplorer_CustomFastScrollView_overlayTextSize, 0);
            mOverlayScrollThumbWidth = typedArray.getDimensionPixelSize(
                    R.styleable.com_zia_freshdocs_widget_fileexplorer_CustomFastScrollView_overlayScrollThumbWidth, 0);
        ...
        mOverlayDrawable = res.getDrawable(android.R.drawable.dialog_frame);
    ...
    public class ScrollFade implements Runnable {
        ...
        long mFadeDuration;
        boolean mStarted;
        static final int ALPHA_MAX = 150;
